...
(setq org-agenda-span 28
      org-agenda-files (file-expand-wildcards "~/school/roam")
      org-agenda-start-on-weekday nil
			org-todo-keywords '((sequence "TODO(t)" "|" "DONE(d)") (sequence "PROJ(p)" "|" "DONE(d)") (sequence "QUIZ(q)" "EXAM(e)" "|" "DONE(d)"))
			org-log-done 'time)
)
...
(map! :leader
      :desc "Toggle comment on line" "c Z" #'toggle-comment-on-line)
